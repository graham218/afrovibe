...
const fields = [
  // avatar heuristic — adjust if you add your own data flag
  !document.querySelector('img[alt$="avatar"]')?.src?.includes('default-avatar'),

  body.dataset.hasBio === '1',
  body.dataset.hasAge === '1',
  body.dataset.hasGender === '1',
  body.dataset.hasOccupation === '1',
  parseInt(body.dataset.interestsCount || '0', 10) > 2,
];
